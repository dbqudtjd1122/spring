...
DROP TABLE TB_Bbs_Article;
DROP TABLE TB_Bbs_Board;
...
CREATE TABLE TB_Bbs_Article (
      articleno     INT           NOT NULL identity(1, 1) 
    , boardcd       NVARCHAR(20)
...
-- 덧글 테이블
DROP TABLE TB_Bbs_Comments;
CREATE TABLE TB_Bbs_Comments (
      commentno     INT UNSIGNED     NOT NULL identity(1, 1) 
    , articleno     INT UNSIGNED     NOT NULL     
    , email         NVARCHAR(60)  
    , memo          NVARCHAR(4000)
    , regdate       DateTime 
                       
    , UseYN         BIT       NULL     DEFAULT  1  
...
-- 첨부파일 테이블
DROP TABLE TB_Bbs_Attachfile;
CREATE TABLE TB_Bbs_Attachfile (
      attachfileno   INT UNSIGNED    NOT NULL identity(1, 1) 
...
CREATE TABLE TB_User (
      userno        INT UNSIGNED    NOT NULL identity(1, 1) 
    , userid        VARCHAR( 50)    NOT NULL
    , email         NVARCHAR(100)   NOT NULL
    , passwd        NVARCHAR( 30)    
    , name          NVARCHAR( 30)    
    , mobile        VARCHAR(20)        
    , retireYN      BIT      NULL     DEFAULT  1  
